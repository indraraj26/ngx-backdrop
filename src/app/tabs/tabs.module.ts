...
@NgModule({
    declarations: [ContentOverlayComponent, FullOverlayComponent, ElementContentOverlayComponent, TabsComponent],
    imports:[CommonModule,NgxBackdropModule, RouterModule.forChild(tabRoutes)]
})
